...
Every char is mapped by a `uint16` short value, corresponding to a ASCII character used by game font, which use VFW in 2 types: `12x24 pixels` or `24x24 pixels`.
